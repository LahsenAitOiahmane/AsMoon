...
import time
from View.BleurConceptScreen.components.fillfield.fillfield import FillField
from View.BleurConceptScreen.components.commonlabel.common_label import CommonLabel
class BlurConceptScreenView(MDScreen):
    ...
    def on_enter(self, *args):
        ...
        if self.x2==0:    
            animation0 = Animation(x = self.ids.field_login.x + dp(10),y=self.ids.greating0.y -dp(140) ,d=2,t="in_out_quart")
            animation0.bind(on_complete=self.translation1)
            animation0.start(self.ids.greating0)
            annimation1 = Animation(y=self.ids.greating.y+ dp(100),d=2,t="in_out_quart")
